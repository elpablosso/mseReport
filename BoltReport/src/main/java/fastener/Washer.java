...
public class Washer implements Fastener {
    ...
    public String toString(){
        ...
        stringBuilder.append("WASHER-").append(diameter).append("-").append(normClass.getName()).append("-")
    ...
    public int sortNumber() {
        return 10000-diameter*10+1000*finishType.name().length();
    }
}
